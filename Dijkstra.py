...
class Station:
    ...
    def addNeighbour(self, station,ticketcost):
        self._neighbours.append(station)
        self._ticketcost.append(ticketcost)
...
class TrainMap:
    ...
    def connectStations(self, fromStation, toStation,cost):
        fromStation.addNeighbour(toStation,cost)
        toStation.addNeighbour(fromStation,cost)
        return self
